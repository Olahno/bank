...
Terminal1::Terminal1(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Terminal1)
{
    ui->setupUi(this);
...
void Terminal1::on_btnback_clicked()
{
    hide();
}

void Terminal1::on_btnlogin_clicked()
{
    QString Login, Pass;
...
void Terminal1::on_brnLogout_clicked()
{
#pragma omp sections
    {
     #pragma omp section
...
void Terminal1::on_btnadd_clicked()
{   int balance;
...
void Terminal1::on_bankBox_currentIndexChanged(int index)
{
   QString ID = QString::number(userid);
...
void Terminal1::on_btnwithdraw_clicked()
{
    int balance;
      if(ui->txtAct->text().toInt()>0)
      {
